...
def main():
    ...
    complete_runs, incomplete_runs = find_incomplete_runs(args.matrix_dir)

    print(f"Test matrix directory: {args.matrix_dir}")
    print(f"Total runs: {len(complete_runs) + len(incomplete_runs)}")
    ...
    if args.json_output:
        results = {
            ...
            "total_runs": len(complete_runs) + len(incomplete_runs),
        }
    ...
    # Remove incomplete runs
    if incomplete_runs:
        remove_incomplete_runs(incomplete_runs, dry_run=args.dry_run)
